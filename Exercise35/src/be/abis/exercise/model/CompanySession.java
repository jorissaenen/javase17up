...
public non-sealed class CompanySession extends Session {
    ...
    public double calculatePrice(){
        ...
        var numberOfDays = this.getCourse().days();
        var basePrice = numberOfDays*this.getCourse().dailyPrice()*numberOfParticipants;
